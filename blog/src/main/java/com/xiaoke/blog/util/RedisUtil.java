...
import com.xiaoke.blog.constants.Status;
...
public class RedisUtil {
    ...
    public void addToRank(int id, int view){
        redisTemplate.opsForZSet().add("rank", id, view);
    }

    public Set<Object> getRank() {
       return redisTemplate.opsForZSet().reverseRange("rank", 0 ,4);
    }
}